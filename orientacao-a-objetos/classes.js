// ------------------------------------------------- CLASSES -----------------------------------------------
class Car {
  // Esta é uma classe onde podemos construir um objeto
  constructor(wheelSize, color, model, power) {
    // através dos atributos passados com this onde este
  ...
  speedUp() {
    // Podemos utilizar funções dentro de classes que no entanto passa a serem chamadas de métodos
    return 'acelerando'
  }
}
...
console.log(
  `Meu carro é da cor ${car1.color} da marca ${car1.model} com rodas de aro ${car1.wheelSize} e uma potência de ${car1.power}!`
)
...
class Pickup extends Car {
  // Podemos extender os métodos e atributos de uma outra classe como da Car
  constructor(wheelSize, color, model, power) {
    // Para utilizar temos que passar os mesmos parâmetros dos atributos que queremos utilizar
