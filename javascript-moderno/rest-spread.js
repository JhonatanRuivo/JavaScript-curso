...
const users = [
  ...names,
  {
    // Com este spread que tem esses 3 pontinhos conseguimos atribuir a constante users todos os
...
const showNumbers = (...numbers) => {
  // Com o REST podemos passar qualquer dado como parâmetro de maneira infinita sem ter
