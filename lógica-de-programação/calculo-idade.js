...
while (ageUser >= 2023 || ageUser <= 1920) {
  // Fazendo uma verificação se o ano que o usuário informou não passa de 2023 e seja
...
function calculateAge() {
  // Função que é responsável pelo calculo da idade do usuário.
