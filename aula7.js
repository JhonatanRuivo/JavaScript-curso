...
while(n < 10) { // Chamando while para repetir enquanto o valor de n for menor que 10
...
// FOR
for(var i = 0; i < 10; i++) { //dentro ddo parenteses já colocamos 3 condições para executar o FOR
    console.log(i) // o resultado será o mesmo que do exemplo anterior mas escrito de maneira diferente
}

//DO
do{ // DO funciona como um while mas a diferença é que ele executa o que está dentro dele pra depois fazer a verificação da condição
