...
images.forEach((item, index) => {
  // Para percorrer todas as images fazemos um forEach
  document
    .querySelectorAll('.bullet-single')
    [index] // Com o index conseguimos pegar a posição do elemento
    .addEventListener('click', () => {
      // com o evento do click no bullet disparamos uma função que
