...
buttonShow.addEventListener('click', () => {
  // Colocamos o evento de click para que assim execute uma function
  let paragraph = document.querySelector('.paragraph') // Pegamos o paragrafo do HTML

  if (paragraph.classList.contains('showParagraph')) {
    // Fazemos uma condicional para mostra o texto inteiro do parágrafo
